...
-- Created/revised by: Sinkidonk on 5/13/15 last revised on 5/15/15, revised by Sinkidonk
...
dofile(minetest.get_modpath("coloredwater").."/cyan.lua")
dofile(minetest.get_modpath("coloredwater").."/lime.lua")
