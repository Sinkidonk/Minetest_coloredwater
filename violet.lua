...
minetest.register_node("coloredwater:water_source_violet", {
	...
	inventory_image = minetest.inventorycube("coloredwater_water_base.png^[colorize:#8401ff80:70]"),
	drawtype = "liquid",
	tiles = {
		{
			name = "coloredwater_water_source_animated_base.png^[colorize:#8401ff80:70]",
			animation = {
...
minetest.register_node("coloredwater:water_flowing_violet", {
	...
	tiles = {"coloredwater_water_base.png^[colorize:#8401ff80:70]"},
	special_tiles = {
		{
			name = "coloredwater_water_flowing_animated_base.png^[colorize:#8401ff80:70]",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
...
bucket.register_liquid(
	...
	"coloredwater_bucket_base.png^[colorize:#8401ff80:70]^coloredwater_bucket_overlay_base.png",
	"Violet Water Bucket"
)
...
minetest.register_node("coloredwater:ice_violet", {
	...
	tiles = {"coloredwater_ice_base.png^[colorize:#8401ff80:70]"},
	is_ground_content = false,
	paramtype = "light",
	groups = {cracky=3},
...
minetest.register_node("coloredwater:snow_violet", {
	...
	tiles = {"coloredwater_snow_base.png^[colorize:#8401ff80:70]"},
	inventory_image = "coloredwater_snowball_base.png^[colorize:#8401ff80:70]",
	wield_image = "coloredwater_snowball_base.png^[colorize:#8401ff80:70]",
