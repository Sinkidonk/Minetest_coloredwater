...
minetest.register_node("coloredwater:water_source_violet", {
	...
	inventory_image = minetest.inventorycube("coloredwater_water_violet.png"),
	drawtype = "liquid",
	tiles = {
		{
			name = "coloredwater_water_source_animated_violet.png",
			animation = {
...
minetest.register_node("coloredwater:water_flowing_violet", {
	...
	tiles = {"coloredwater_water_violet.png"},
	special_tiles = {
		{
			name = "coloredwater_water_flowing_animated_violet.png",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
...
bucket.register_liquid(
	...
	"coloredwater_bucket_violet.png",
	"Violet Water Bucket"
)
...
minetest.register_node("coloredwater:ice_violet", {
	...
	tiles = {"coloredwater_ice_violet.png"},
	is_ground_content = false,
	paramtype = "light",
	groups = {cracky=3},
...
minetest.register_node("coloredwater:snow_violet", {
	...
	tiles = {"coloredwater_snow_violet.png"},
	inventory_image = "coloredwater_snowball_violet.png",
	wield_image = "coloredwater_snowball_violet.png",
