...
minetest.register_node("coloredwater:water_source_aqua", {
	...
	inventory_image = minetest.inventorycube("coloredwater_water_aqua.png"),
	drawtype = "liquid",
	tiles = {
		{
			name = "coloredwater_water_source_animated_aqua.png",
			animation = {
...
minetest.register_node("coloredwater:water_flowing_aqua", {
	...
	tiles = {"coloredwater_water_aqua.png"},
	special_tiles = {
		{
			name = "coloredwater_water_flowing_animated_aqua.png",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
...
minetest.register_node("coloredwater:ice_aqua", {
	...
	tiles = {"coloredwater_ice_aqua.png"},
	is_ground_content = false,
	paramtype = "light",
	groups = {cracky=3},
...
minetest.register_node("coloredwater:snow_aqua", {
	...
	tiles = {"coloredwater_snow_aqua.png"},
	inventory_image = "coloredwater_snowball_aqua.png",
	wield_image = "coloredwater_snowball_aqua.png",
