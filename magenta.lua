...
minetest.register_node("coloredwater:water_source_magenta", {
	...
	inventory_image = minetest.inventorycube("coloredwater_water_base.png^[colorize:#ff01fc80:70]"),
	drawtype = "liquid",
	tiles = {
		{
			name = "coloredwater_water_source_animated_base.png^[colorize:#ff01fc80:70]",
			animation = {
...
minetest.register_node("coloredwater:water_flowing_magenta", {
	...
	tiles = {"coloredwater_water_base.png^[colorize:#ff01fc80:70]"},
	special_tiles = {
		{
			name = "coloredwater_water_flowing_animated_base.png^[colorize:#ff01fc80:70]",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
...
bucket.register_liquid(
	...
	"coloredwater_bucket_base.png^[colorize:#ff01fc80:70]^coloredwater_bucket_overlay_base.png",
...
minetest.register_node("coloredwater:ice_magenta", {
	...
	tiles = {"coloredwater_ice_base.png^[colorize:#ff01fc80:70]"},
	is_ground_content = false,
	paramtype = "light",
	groups = {cracky=3},
...
minetest.register_node("coloredwater:snow_magenta", {
	...
	tiles = {"coloredwater_snow_base.png^[colorize:#ff01fc80:70]"},
	inventory_image = "coloredwater_snowball_base.png^[colorize:#ff01fc80:70]",
	wield_image = "coloredwater_snowball_base.png^[colorize:#ff01fc80:70]",
